...
class TopExperiencePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _TopExperiencePageState();
  }
}

class _TopExperiencePageState extends State<TopExperiencePage> {
  ...
  void loadLeaderboard() async {
    List<Map<String, dynamic>> leaderboard =
        await databaseService.fetchLeaderboardExp();
    setState(() {
      users = leaderboard;
  ...
  String formatScore(int? score) {
    ...
    return  "LVL " + _removeTrailingZero(score / 10000);
  }
