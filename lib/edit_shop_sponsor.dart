...
class EditShopSponsorPage extends StatefulWidget {
  final Function(int) togglePage;

  EditShopSponsorPage({required this.togglePage});

  @override
  State<StatefulWidget> createState() {
    return _EditShopSponsorPageState();
  }
}

class _EditShopSponsorPageState extends State<EditShopSponsorPage> {
