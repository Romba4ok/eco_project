...
class ExamplesExamplesPage extends StatefulWidget {
  final Function(int) togglePage;

  ExamplesExamplesPage({required this.togglePage});

  @override
  State<StatefulWidget> createState() {
    return _ExamplesExamplesPageState();
  }
}

class _ExamplesExamplesPageState extends State<ExamplesExamplesPage> {
